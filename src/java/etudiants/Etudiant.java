...
public class Etudiant 
{
    ...
    public Etudiant(String nom, String prenom, String login, String mp, String groupe, long cin, String genre) {
        this.nom = nom;
        this.prenom = prenom;
        this.login = login;
        this.mp = mp;
    ...
    public static Etudiant login_etudiant(String login,String mp)
    {
        ...
        try 
        {
            ...
            while (rs.next()) 
            {
                ...
                et.setGenre(rs.getString("genre"));
    ...
    public static void ajout (Etudiant etu)
    {
        ...
        {
            Connection con = ConnectionDb.getConnexion();
            PreparedStatement reqSauvegarder = con.prepareStatement("insert into issatintranet.etudiants values (?,?,?,?,?,?,?)");
            ...
            reqSauvegarder.setString(5, etu.genre);
